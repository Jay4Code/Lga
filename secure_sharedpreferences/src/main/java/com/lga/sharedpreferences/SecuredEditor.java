...
public class SecuredEditor implements Editor {
    ...
    /**
     * Initializes with the {@link EncryptionHelper} an the original {@link Editor}.
     *
    ...
    /**
     * Compatibility version of original {@link Editor#apply()}
     * method that simply call {@link Editor#commit()} for pre Android Honeycomb (API 11).
