...
final class SecureUtils {
    ...
    static void migrateData(SharedPreferences from, SharedPreferences to, int version) {
     ...
     */
    static int getVersion(SharedPreferences preferences) {
